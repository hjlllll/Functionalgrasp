...
def write_xml(obj_name, r, t, a, path, mode='train', rs=(21, 'real')):
    ...
    if mode=='new':
        name_text=dom.createTextNode('/home/lm/Documents/ddg_data/grasp_dataset/good_shapes/{}.xml'.format(str(obj_name)))
        # name_text=dom.createTextNode('/home/lm/Documents/ddg_data/grasp_dataset/good_shapes/{}_scaled.obj.smoothed.xml'.format(str(obj_name)))
