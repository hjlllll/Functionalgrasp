...
# # little finger
ml10 = mat4x4_xyz(46.4, 4.3, 0)  # 4.3还是3.6并不确定
...
ml60 = mat4x4_xyz(26, 0, 0)  # 此处依据说明书中尺寸图而定
ML6 = ml60
...
M_shadowhand = np.asarray([ML1, ML2, ML3, ML4, ML5, ML6, MR1, MR2, MR3, MR4, MR5, MM1, MM2, MM3, MM4, MM5, MI1, MI2, MI3, MI4, MI5, MT1, MT2, MT3, MT3_4, MT4, MT5])
...
#########################################################################################################################################################################
# # 计算辅助点，各link尺寸由draft_of_shadow2.py计算，各参数对应参考onenote图 (shadowhand说明书上有更详细的图，建议参考并修改，目前未修改)
